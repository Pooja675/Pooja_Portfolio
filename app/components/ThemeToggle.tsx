...
const ThemeToggle = () => {
  const [isDarkMode, setIsDarkMode] = useState<boolean>(true); // Default value
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed top-[58px] left-6 md:top-16 md:left-auto md:right-[42px] w-9 h-[18px] bg-[#1a1a1a] dark:bg-[#efefef] 
